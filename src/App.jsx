  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/world-pharmaceutical-summit-orators" element={<Orators />} />
        <Route path="/about-global-pharmaceutical-conclave" element={<AboutOralMed />} />
        <Route path="/pharmaceutical-event-schedule" element={<EventSchedule />} />
