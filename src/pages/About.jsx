...
const data = {
  event: {
    ...
    description: [
      <>
        At Helix Conferences, we are committed to fostering dialogue,
        discovery, and collaboration through world-class pharmaceutical
        conferences and summits. As a leading organizer of the Global
        Pharmaceutical Conclave and the World Pharmacology Summit, our mission
        is to connect stakeholders across the pharmaceutical ecosystem to
        accelerate global health solutions.
      </>,
      <>
        From emerging biotech to big pharma, from regulatory trends to Research
        ethics—we curate thought-provoking content and create impactful spaces
        where innovation thrives. Explore our{" "}
        <Link
        ...
        to engage with dynamic sessions across the full pharma value chain.
      </>,
    ],
  },
  ...
  return (
    <div className="w-full 2xl:max-w-[1280px] mx-auto justify-center items-center text-center">
      ...
      <h1 className="text-4xl mt-2 font-bold text-one">
        A CONFERENCE ON PHARMATECH-2026
      </h1>
      <p className="text-center text-gray-600 text-3xl mb-6">
        <strong>
          22<sup>th</sup> - 23<sup>th</sup> Oct 2026
        </strong>
      </p>
      ...
      <section className="mb-10 text-center w-full min-w-4xl px-2 md:px-12 lg:px-24">
        <h2 className="text-3xl font-bold text-one mb-4 w-full">
          Join the Global Community at PHARMATECH Conference 2026
        </h2>
